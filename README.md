...
* **[MkDocs](https://www.mkdocs.org/):** Generador de sitios estáticos orientado a documentación.
* **[Material for MkDocs](https://squidfunk.github.io/mkdocs-material/):** El tema (plantilla) utilizado para el diseño profesional y modo oscuro.
* **MathJax:** Para el renderizado de ecuaciones matemáticas complejas.
* **GitHub Actions:** Para el despliegue automático cada vez que se suben nuevas notas.
